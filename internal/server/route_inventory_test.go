...
var expectedGoRoutes = []string{
	...
	"POST /v1/projects/{project}/issues/{issue_number}/runs/{run_number}/cycles/{cycle_number}/touchpoint/merge",
	...
	"POST /v1/run-callbacks/{callback_token}/native/github-agent-token",
