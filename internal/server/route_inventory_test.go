...
var expectedGoRoutes = []string{
	...
	"GET /v1/previews",
	"POST /v1/previews",
	"GET /v1/previews/{project}/{name}",
	"DELETE /v1/previews/{project}/{name}",
	"POST /v1/previews/{project}/{name}/push-receipt",
	"POST /v1/previews/{project}/{name}/enable",
	"POST /v1/previews/{project}/{name}/disable",
	"GET /v1/workflows",
	"POST /v1/workflows",
