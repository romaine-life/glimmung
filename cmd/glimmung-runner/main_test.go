...
func TestAgentStepBaseEnvStripsManagedSecrets(t *testing.T) {
	got := agentStepBaseEnv([]string{
		...
		"GLIMMUNG_GITHUB_AGENT_TOKEN_URL=https://glimmung.test/github-agent-token",
		"GLIMMUNG_GITHUB_PUSH_POLICY_TOKEN=policy-token",
		"GLIMMUNG_GITHUB_PUSH_POLICY_TOKEN_URL=https://glimmung.test/github-push-policy-token",
		"GLIMMUNG_PR_REVIEW_URL=https://glimmung.test/review",
