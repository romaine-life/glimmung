  ...
  preview_environments: [
    {
      project: "glimmung",
      name: "session-1219",
      lease_ref: "preview-glimmung-session-1219",
      session_id: "1219",
      authorized_subject: "tank/session/1219",
      enabled: true,
      state: "live",
      url: "https://glimmung-session-1219.preview.romaine.life",
      upstream_url: "http://127.0.0.1:8080",
      backend_prefixes: ["/v1", "/healthz", "/readyz", "/metrics", "/og"],
      image_tag: "glimmung:sha-abc1234",
      edge_image: "live-preview-edge:0.3.1",
      live_build_id: "build-7f3a91c",
      pushed_at: ago(6),
      observed_build_id: "build-7f3a91c",
      observed_at: ago(5),
      detail: "",
      created_at: ago(40),
      updated_at: ago(5),
    },
    {
      project: "glimmung",
      name: "session-1184",
      lease_ref: "preview-glimmung-session-1184",
      session_id: "1184",
      authorized_subject: "tank/session/1184",
      enabled: true,
      state: "stale",
      url: "https://glimmung-session-1184.preview.romaine.life",
      upstream_url: "http://127.0.0.1:8080",
      backend_prefixes: ["/v1", "/healthz", "/readyz", "/metrics", "/og"],
      image_tag: "glimmung:sha-abc1234",
      edge_image: "live-preview-edge:0.3.1",
      live_build_id: "build-22dd0fe",
      pushed_at: ago(12),
      observed_build_id: "build-9911aa0",
      observed_at: ago(11),
      detail: "edge serving build build-9911aa0, expected build-22dd0fe",
      created_at: ago(80),
      updated_at: ago(11),
    },
    {
      project: "ambience",
      name: "session-1190",
      lease_ref: "preview-ambience-session-1190",
      session_id: "1190",
      authorized_subject: "tank/session/1190",
      enabled: true,
      state: "pushed",
      url: "https://ambience-session-1190.preview.romaine.life",
      upstream_url: "http://127.0.0.1:3000",
      backend_prefixes: ["/api", "/healthz"],
      image_tag: "ambience:sha-deadbee",
      edge_image: "live-preview-edge:0.3.1",
      live_build_id: "build-4c5e2a1",
      pushed_at: ago(1),
      observed_build_id: "",
      observed_at: null,
      detail: "",
    ...
    },
    {
      project: "ambience",
      name: "session-1201",
      lease_ref: "preview-ambience-session-1201",
      session_id: "1201",
      authorized_subject: "tank/session/1201",
      enabled: true,
      state: "ready",
      url: "https://ambience-session-1201.preview.romaine.life",
      upstream_url: "http://127.0.0.1:3000",
      backend_prefixes: ["/api", "/healthz"],
      image_tag: "ambience:sha-deadbee",
      edge_image: "live-preview-edge:0.3.1",
    ...
    },
    {
      project: "glimmung",
      name: "session-1042",
      lease_ref: "preview-glimmung-session-1042",
      session_id: "1042",
      authorized_subject: "tank/session/1042",
      enabled: false,
      state: "disabled",
      url: "https://glimmung-session-1042.preview.romaine.life",
      upstream_url: "http://127.0.0.1:8080",
      backend_prefixes: ["/v1", "/healthz"],
      image_tag: "glimmung:sha-abc1234",
      edge_image: "live-preview-edge:0.3.1",
      live_build_id: "build-1112ccd",
      pushed_at: ago(600),
      observed_build_id: "build-1112ccd",
      observed_at: ago(590),
      detail: "",
      created_at: ago(900),
      updated_at: ago(120),
  ...
  projects: [
    {
      ...
      argocd_app: "glimmung",
      metadata: { owner: "platform", portfolio: true, live_preview: { enabled: true, backend_prefixes: ["/v1", "/healthz", "/readyz", "/metrics", "/og"] } },
      created_at: ago(9000),
    },
    {
      id: "project-ambience",
      ...
      argocd_app: "ambience",
      metadata: { owner: "apps", live_preview: { enabled: true, backend_prefixes: ["/api", "/healthz"] } },
      created_at: ago(6000),
    },
  ],
  workflows: [
